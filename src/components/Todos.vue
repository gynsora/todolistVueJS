<template>
  <section class="todoapp">
    <header class="header">
      <h1>Todos</h1>
      <input type="text" class="new-todo" placeholder="Ajouter un message" v-model="newTodo" @keyup.enter="addTodo" >
    </header>
    <div class="main">
    ...
    <footer class="footer" v-show="hasTodos" >
      ...
      <ul class="filters">
        ...
        <li><a href="#" :class="{selected: filter === 'undone'}" @click.prevent="filter = 'undone'">à faire</a></li>
        <li><a href="#" :class="{selected: filter === 'done'}" @click.prevent="filter = 'done'">terminé</a></li>
      </ul>
...
export default {
  ...
  methods: {
    ...
    deleteTodo (todoSelected) {
      this.todos = this.todos.filter(i => i !== todoSelected)
    },
    deleteCompleted () {
